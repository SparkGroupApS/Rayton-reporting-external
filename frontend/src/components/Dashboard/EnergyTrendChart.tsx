...
import {
  ...
  Spinner,
  Switch,
  Text // --- Add Switch for Chakra UIText
...
const EnergyTrendChart = ({
  ...
  const {
    ...
    {
      enabled: !!tenantId && energyDataIds.length > 0, // Updated enabled check
    },
  )
  ...
  const {
    ...
    {
      enabled: !!tenantId, // Updated enabled check
    },
  )
                  ...
                  <XAxis
                    ...
                    tickFormatter={
                      interval === "hourly" && hourlyTicks
                        ? (tick, index) =>
                            formatHourlyTick(tick, index, hourlyTicks.length)
                        : (timestamp) =>
